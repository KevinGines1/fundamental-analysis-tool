...
function LeftPanel(props: DrawerProps): JSX.Element {
    ...
    return(
        <>
            <Drawer
                ...
                open={open}
                onClose={onClose}
                PaperProps={{sx: {backgroundColor: "rgba(39, 45, 53, 1)", color: "white"}}}
                >
                <Box
                    sx={{width: 350}}
                >
                ...
                >
                    ...
                    <ListItem disablePadding>
                        <ListItemButton onClick={() => setOpenDev(!openDev)}>
                        <ListItemIcon>
                    ...
                    {/* SOCIALS */}
                    <ListItem disablePadding>
                        <ListItemButton onClick={() => setOpenSocials(!openSocials)}>
                        <ListItemIcon>
                    ...
                    <Collapse in={openSocials}>
                        <ListItem sx={{pl: 4}}>
                            <ListItemButton onClick={() => openInNewTab(githubProfile)}>
                            <ListItemIcon>
                                <SvgIcon>
                        ...
                        <ListItem sx={{pl: 4}}>
                            <ListItemButton onClick={() => openInNewTab(linkedInProfile)}>
                            <ListItemIcon>
                                <SvgIcon>
                                <svg viewBox="0 0 128 128">
